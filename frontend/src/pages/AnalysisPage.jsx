    ...
    return (
        <div className="app-layout">
            ...
            <main className="main-content">
                <div className="navbar"><h1>🔍 Log Analysis</h1></div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            >
                                ...
                                <p style={{ fontSize: 12, marginTop: 4 }}>TXT, CSV, JSON — Max 10MB</p>
                ...
                <div className="card">
                    ...
                    {historyLoading ? <div className="spinner" /> : analyses.length === 0 ? (
                            ...
                            <tbody>
                                {analyses.map((a) => (
                                    <tr key={a._id}>
                                        ...
                                        <td>
                                            <button className="btn btn-secondary btn-sm" onClick={() => handleGenerateReport(a._id)}>📝 Report</button>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
